...
public class PlayfairCipher {
    ...
    public static void main(String[] a) {
        ...
        System.out.print("Keyword: "); gen(sc.nextLine());
        System.out.println("Matrix:"); for (char[] r : m) { for (char c : r) System.out.print(c+" "); System.out.println(); }
        System.out.print("Plaintext: "); System.out.println("Encrypted: " + enc(sc.nextLine()));
        sc.close();
    }
}
